...
export const signUp = createAsyncThunk("/users/sign-up", async (form, thunkApi) => {
...
export const {changeMail, changePassword, changeName, changeFirstname} = signupSlice.actions;
